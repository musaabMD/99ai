            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <Input
                  ...
                  className="w-full px-6 py-4 text-lg rounded-2xl border-0 bg-white shadow-lg focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 focus:ring-offset-[#F3F2F1] font-medium"
                  required
                />
                <ValidationError 
                  prefix="Email" 
              ...
              <div>
                <textarea
                  id="message"
                  name="message"
                  placeholder="Tell us what you'd like to build with AI agents (optional)"
                  className="w-full px-6 py-4 text-lg rounded-2xl border-0 bg-white shadow-lg focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 focus:ring-offset-[#F3F2F1] resize-none font-medium"
                  rows={4}
                />
                <ValidationError 
                  prefix="Message" 
              ...
              <Button 
                ...
                size="lg" 
                className="w-full bg-black hover:bg-gray-800 text-white px-8 py-4 rounded-2xl font-semibold text-lg shadow-lg transition-all duration-200"
              >
